...
!!! warning
    **The name of the `ProviderConfig` needs to be `storage-minio`!**
...
Now we can update `provider-kubernetes` with a `DeploymentRuntimeConfig` to use this new `ServiceAccount`.
